...
def demo_bm25():
    ...
    test_queries = [
        ("Qwen LLM", "英文查询，纯关键词"),
        ("千问大模型", "中文查询，纯关键词"),
        ("what's the best open source model", "英文查询，常见词汇"),
        ("大模型和LLM的区别", "中英混合查询"),
    ]
    ...
    for weight in [0.2, 0.5, 0.8]:
        ...
        print(f"\n权重 (BM25={weight}, Vector={1-weight}):")
